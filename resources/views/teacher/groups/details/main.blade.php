...
<script>
    ...
    var myDropzoneTheFirst = new Dropzone(
        ...
        '#file-dropzone', { 
            url: 'http://127.0.0.1:8000/teacher/groups/images/add/' + x + '/' + groupId,
...
var myDropzoneTheSecond = new Dropzone(
        ...
        '#file-dropzone8', { 
            url: 'http://127.0.0.1:8000/teacher/groups/videos/add/' + y + '/' + groupId,
    ...
    var myDropzoneThefile = new Dropzone(
        //id of drop zone element 2
        '#file-dropzonefile', { 
            url: 'http://127.0.0.1:8000/teacher/groups/files/add/' + z + '/' + groupId,
            acceptedFiles: ".pdf",
            addRemoveLinks: true,
            maxFilesize: 1000,
            headers: {
    ...
    var myDropzoneTheAudio = new Dropzone(
        //id of drop zone element 2
        '#file-dropzoneaudio', { 
            url: 'http://127.0.0.1:8000/teacher/groups/audios/add/' + t + '/' + groupId,
